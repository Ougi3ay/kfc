...
def run_regression_example():
    ...
    clusterer1 = KMeansBregman(divergence='euclidean' ,n_clusters=4, n_init=10, random_state=1)
...
def run_classification_example():
    ...
    clusterer1 = KMeansBregman(divergence='euclidean', n_clusters=3, n_init=10, random_state=1)
